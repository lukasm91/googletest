...
function(install_project)
  if(INSTALL_GTEST)
    ...
    endforeach()
    set(_installed_libraries $CACHE{gtest_installed_libraries})
    list(APPEND _installed_libraries ${ARGN})
    list(REMOVE_DUPLICATES _installed_libraries)
    set(gtest_installed_libraries "${_installed_libraries}" CACHE INTERNAL "")
  endif()
endfunction()
